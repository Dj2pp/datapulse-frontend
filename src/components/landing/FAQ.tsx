...
const faqs = [
  { q: "What file formats are supported?", a: "DataPulse supports Excel (.xlsx, .xls), CSV, and TSV files. You can upload files up to 50MB on the free plan and up to 500MB on Pro." },
  ...
  { q: "Is my data secure and private?", a: "Yes. Files are processed in isolated, ephemeral compute environments and never written to permanent storage. All data is encrypted in transit (TLS 1.3) and at rest (AES-256). We are SOC 2 Type II certified and GDPR compliant." },
  { q: "Can I automate uploads via API?", a: "Yes, the DataPulse REST API allows you to submit files, poll for results, and retrieve structured JSON reports programmatically. API access is available on Pro and Enterprise plans." },
